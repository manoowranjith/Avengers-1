...
const characters=['superman','batman','spiderman','jordan','thor','captain america','supergirl','aquaman','power','black panther','steel','wonderwoman','professor','wasp','beast','animal','congorilla','geo','damage','vision']
const character_obj=[]
var l=0,d=0;
